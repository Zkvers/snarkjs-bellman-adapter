...
// const poseidon = buildPoseidonOpt().catch(err => { console.log(err) });
var poseidonHash = function (items) {
    (0, circomlibjs_1.buildPoseidonOpt)().then(function (poseidon) { return ethers_1.BigNumber.from(poseidon(items).toString()); });
};
